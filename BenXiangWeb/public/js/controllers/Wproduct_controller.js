                       ...
                       ////////////////////////添加产品到购物车//////////////////////////
                          ...
                          ///////////////////////////获取购物车//////////////////////////
							...
							$scope.ImmediateOrder = function (product){
                                       if(product.inventory > 0){
										   window.location.href = window.location.protocol + '//' + window.location.host + '/w/pay?pid=' + product.id + '&num=' + $scope.quantity + '&price=' + $scope.selectprice  + '&kouwei=' + $scope.selectedTheme.name  + '&productAmount=' + $scope.selectprice*$scope.quantity
									   }
								else{
										   alert('该商品已抢光,亲可以去看看其他商品哦!')
									   }
