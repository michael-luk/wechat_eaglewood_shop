    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
           ...
           //{field: 'shipCity', displayName: '城市', width: '80'},
            ...
            {field: 'shipLocation', displayName: '详细地址', width: '150', cellTemplate: '<div ng-bind-html="COL_FIELD | safehtml"></div>'},
            ...
            {field: '', displayName: '打印发货单', width: '100', cellTemplate: '<div><a href="/report/userorders?Id={{gridOptions.selectedItems[0].id}}" style="color:black"><input type="button" value="打印发货单"></div>'},
            {
                field: 'comment',
                displayName: '物流信息',
                width: '250',
