var app = angular.module('matrixaApp', []);
...
app.controller('matrixaController', [
    '$scope',
    '$http',
    ...
    function ($scope, $http) {
        ...
        function refreshDate() {
            $http.get('/infos?size=8&classify=集团连州基地&page=' + $scope.page).success(
                function (data, status, headers, config) {
                    if (data.flag) {
                        $scope.matrixas = data.data
