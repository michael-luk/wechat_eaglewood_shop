...
public class ProductModel extends Model implements Serializable, IConst {
	...
	@Lob
	public String descriptionImages; // 产品图
	...
	@OneToMany(cascade = CascadeType.ALL, mappedBy = "product")
	public List<FoodcommentModel> foodcomments; // 产品评价

	@OneToMany(cascade = CascadeType.ALL, mappedBy = "product")
	public List<ShoppingCartItemModel> cartItems; // 购物车商品

	@OneToMany(cascade = CascadeType.ALL, mappedBy = "product")
	public List<ActivityHistoryModel> activityhistory; // 活动历史
